...
{"itens":[{"descricao":"texto da linha do item","unidade":"un|kg|m|m²|m³|sc|L|gl|bd|cx|rl|pç","quantidade":number,"preco_unit":number,"ipi_pct":number,"desc_pct":number,"ecr_id":number_or_null}]}
...
${ecrsList}
- "unidade" deve ser uma das unidades padrão. Mapeie variações ("UN"→"un", "KG"→"kg", "M2"→"m²").
- Ignore totais, subtotais, cabeçalhos, dados do cliente/fornecedor/loja.
